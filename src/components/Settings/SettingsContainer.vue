<template>
  <section v-bind:class="{ 'settings-hidden': !settingsVisible }">
    <div class="options-outer" id="custom-added-container" data-v-0222a7c0></div>
    <SearchBar ref="SearchBar" @user-is-searchin="userIsTypingSomething" v-if="searchVisible" />
